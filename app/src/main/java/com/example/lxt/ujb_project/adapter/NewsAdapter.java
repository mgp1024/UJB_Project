...
public class NewsAdapter extends ArrayAdapter<Insur> {

	private List<Insur> insurs;
	/**
	 * ͼƬӲ�̻�������ࡣ
	 */
	...
	public NewsAdapter(Context context, int resource, List<Insur> objects,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final Insur insur = getItem(position);
		// ���ָ��3���ַ���
	...
	public void addNews(List<Insur> addNews) {
		for (Insur hm : addNews) {
			insurs.add(hm);
		}
