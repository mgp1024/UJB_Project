...
public class SecondAdviceActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			File path = getDiskCacheDir(SecondAdviceActivity.this, "File");
			if (!path.exists()) {
				path.mkdirs();
			}
	...
	public void onResume() {
		...
		mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if(size!=0){
					Intent intent = new Intent(SecondAdviceActivity.this, AdviceItemActivity.class);
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Net_OK:
				...
				mAdapter = new KnowledgeAdapter(SecondAdviceActivity.this, 0, knowledges, mListView);
	...
	public void getLocalNews() {
		String url = URLCollect.BASE_URL + URLCollect.KNOWLEDGE_URL + "page="+page+"&cate=1&pagesize=10";
	...
	public void getSimulationNews() {
		final String url = URLCollect.BASE_URL + URLCollect.KNOWLEDGE_URL + "page=" + page + "&cate=1&pagesize=10";
	...
	class LvOnRefreshListener implements OnRefreshListener2<ListView> {
		...
		public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
			...
			String label = DateUtils.formatDateTime(SecondAdviceActivity.this, System.currentTimeMillis(), DateUtils.FORMAT_SHOW_TIME | DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);
	...
	class GetUpTask extends AsyncTask<String, Void, Integer> {
		...
		protected void onPostExecute(Integer result) {
			super.onPostExecute(result);
			page = page + 1;
			if (NetUtils.isConnected(SecondAdviceActivity.this) == true) {
				getSimulationNews();
			} else {
				getLocalNews();
			}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.iv_back:
			SecondAdviceActivity.this.finish();
			break;
